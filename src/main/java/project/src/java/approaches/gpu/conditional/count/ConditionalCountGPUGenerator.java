package project.src.java.approaches.gpu.conditional.count;
...
public class ConditionalCountGPUGenerator {
    public static void execute(List<Tree> trees, String dataset) {
    	System.out.println("Generating code...");
        String sourceCode = new String();

        sourceCode += TestCountFileGenerator.generateFunctions(dataset);
        ...
        sourceCode += TestCountFileGenerator.generateMainFunction(Parser.featuresNames.size(), Parser.samplesQuantity);
        
        System.out.println("Writing File...");
        FileBuilder.execute(sourceCode, "gpu/conditional/rf_with_if_count.cu");
    }
