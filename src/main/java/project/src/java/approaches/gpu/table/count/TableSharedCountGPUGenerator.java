...
public class TableSharedCountGPUGenerator {
	public static void execute(List<Tree> trees, String dataset) {
        ...
        FileBuilder.execute(sourceCode, "gpu/table/shared/rf_with_table_count.cu");
    }
	...
	private static String generateThreadAndTrees(int featuresQuantity, int classesQuantity, List<Tree> trees) {
	    ...
	    String code = "__global__ void RF_with_table(int *table, float *thresholds,"+features+", int *P, const int N){\n";
