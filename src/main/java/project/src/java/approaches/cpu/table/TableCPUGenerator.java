package project.src.java.approaches.cpu.table;
...
public class TableCPUGenerator {
	...
	private static String generateAuxiliarFunctions(String dataset) {
		return "\r\n"
				...
				+ "{\r\n"
				+ "    FILE *file = fopen(\"generated/cpu/table/out_rf_table_cpu.csv\", \"w\");\r\n"
				+ "    if (file == NULL) {\r\n"
				+ "        printf(\"[C - Random Forest]: Failed to open the file.\\n\");\r\n"
				+ "        return;\r\n"
				+ "    }\r\n"
				...
				+ "    FILE *file = fopen(\"generated/cpu/table/results.csv\", \"a\"); // Abre o arquivo no modo de \"acrescentar\" (append)\r\n"
				+ "    if (file == NULL) {\r\n"
	...
	private static String generateMasksandIncludes() {
		String code = "#include <stdio.h>\r\n"
				...
				+ "#define N_ELEM "+(Parser.samplesQuantity + 1)+"\r\n"
